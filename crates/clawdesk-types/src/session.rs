    ...
    fn from(s: String) -> Self {
        ...
        if let Some(colon) = s.find(':') {
            ...
            let channel = match channel_str {
                ...
                "line" => ChannelId::Line,
                "googlechat" => ChannelId::GoogleChat,
                "msteams" => ChannelId::MsTeams,
                "nostr" => ChannelId::Nostr,
                "irc" => ChannelId::Irc,
                "mattermost" => ChannelId::Mattermost,
                "email" => ChannelId::Email,
                "feishu" | "lark" => ChannelId::Feishu,
                "twitch" => ChannelId::Twitch,
                "nextcloud_talk" | "nextcloudtalk" => ChannelId::NextcloudTalk,
                "zalo" => ChannelId::Zalo,
                "tlon" | "urbit" => ChannelId::Tlon,
                _ => {
