...
| **Skill Registry** | 15 built-in skills ported from [OpenClaw's skill system](https://github.com/anthropics/openclaw), with hot-loading, activation/deactivation, and per-skill ACLs. |
